...
norwegian_projects_details_heurope = df_projects_heurope[
    df_projects_heurope['id'].isin(norwegian_projects_ids_heurope)].copy()
...
norwegian_projects_details_h2020['ecMaxContribution'] = pd.to_numeric(
    norwegian_projects_details_h2020['ecMaxContribution'].str.replace(',', '.'), errors='coerce')
...
print()
print()
print("Project from Norwegian organizations in Horizon 2020")
print()
...
print()
# Print the results
print("Projects per Time Interval Number of Projects:")
